...
(defn day2-solutions
  []
  (println (day2/solution-1))
  (println (day2/solution-2)))
...
(defn day6-solutions
  []
  (println (day6/solution-1))
  (println (day6/solution-2)))

(defn day7-solutions
  []
  (println (day7/solution-1))
  (println (day7/solution-2)))
